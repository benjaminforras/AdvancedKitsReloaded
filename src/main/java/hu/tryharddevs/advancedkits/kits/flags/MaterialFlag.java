...
public class MaterialFlag extends Flag<Material> {
	...
	@Nullable @Override public Material getDefault() {
		return defaultValue;
	}

	@Override public Material parseInput(String input) throws InvalidFlagValueException {
		Material material = Material.matchMaterial(input);
		if (Objects.isNull(material)) {
			throw new InvalidFlagValueException(Config.CHAT_PREFIX + " " + getMessage("notValidIcon2"));
		}

		return material;
	}

	@Nullable @Override public Material parseItem(Player player) throws InvalidFlagValueException {
	...
	@Override public Material unmarshal(@Nullable Object o) {
		return Material.valueOf(String.valueOf(o));
	}

	@Override public Object marshal(Material o) {
		return o.toString();
	}
}
