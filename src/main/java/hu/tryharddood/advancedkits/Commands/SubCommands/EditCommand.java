...
public class EditCommand extends Subcommand {
	...
	public void onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		inventory.setItem(inventorySize - 4, new ItemBuilder(Material.STAINED_GLASS_PANE, (short) 13).setTitle(ChatColor.GREEN + "" + ChatColor.BOLD + ChatColor.stripColor(tl("gui_button_edit"))).build());
