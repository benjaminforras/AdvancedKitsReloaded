...
import hu.tryharddood.advancedkits.Utils.BossBarAPI.reflection.Reflection;
...
public class BossBarAPI implements Listener {
	 ...
	 * @param color      {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Color}
	 * @param style      {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Style}
	 * @param progress   progress (0.0 - 1.0)
	 * @param properties {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Property}
	...
	public static BossBar addBar(Collection<Player> players, BaseComponent component, Color color, Style style, float progress, int timeout, long interval, Property... properties) {
		...
		new BossBarTimer((PacketBossBar) bossBar, progress, timeout).runTaskTimer(AdvancedKits.getInstance(), interval, interval);
		return bossBar;
	}
	 ...
	 * @param component  displayed message
	 * @param color      {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Color} (1.9-only)
	 * @param style      {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Style} (1.9-only)
	 * @param progress   progress (0.0 - 1.0)
	 * @param properties {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Property} (1.9-only)
	 * @return the new {@link BossBar} instance
	...
	protected void handlePlayerTeleport(Player player, Location from, Location to) {
		...
		}.runTaskLater(AdvancedKits.getInstance(), 2);
	}
	...
	public void onMove(final PlayerMoveEvent e) {
		if (Minecraft.VERSION.olderThan(Minecraft.Version.v1_9_R1)) {
			...
			if (bar != null) {
				...
				}.runTaskLater(AdvancedKits.getInstance(), 0);
			}
		}
	}
