...
public interface BossBar {
	...
	/**
	 * @return the {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Color}
	 */
	BossBarAPI.Color getColor();

	/**
	 * @param color the new {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Color}
	 */
	void setColor(BossBarAPI.Color color);

	/**
	 * @return the {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Style}
	 */
	BossBarAPI.Style getStyle();

	/**
	 * @param style the new {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Style}
	 */
	 ...
	 * Modify a property
	 *
	 * @param property {@link hu.tryharddood.advancedkits.Utils.BossBarAPI.BossBarAPI.Property}
