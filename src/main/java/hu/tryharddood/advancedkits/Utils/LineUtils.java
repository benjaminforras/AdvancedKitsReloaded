...
public class LineUtils {
	...
	public static String getCenteredMessage(Aligns align, String message) {
		...
		int           halvedMessageSize = messagePxSize / align.val;
		int           toCompensate      = (CENTER_PX / align.val) - halvedMessageSize;
