...
public final class PageInventory extends ClickInventory<Object>
{
    ...
    public ItemStack getBackPage()
    {
        if (backAPage == null)
        {
            backAPage = InventoryApi.setNameAndLore(new ItemStack(Material.PAPER), ChatColor.RED + phrase("menu_back"), phrase("menu_back_lore"));
        }
        return backAPage;
    }
    ...
    public ItemStack getForwardsPage()
    {
        ...
        {
            forwardsAPage = InventoryApi.setNameAndLore(new ItemStack(Material.PAPER), ChatColor.RED + phrase("menu_next"), phrase("menu_next_lore"));
        }
